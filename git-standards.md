...
When the source code in the `develop` branch is master and has been deployed, all of the changes will be merged into `master` and tagged with a release number. *How this is done in detail will be discussed later.*
